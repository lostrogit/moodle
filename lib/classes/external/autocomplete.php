...
class autocomplete extends external_api {
    ...
    public static function execute(string $query): array {
        ...
        foreach ($findings as $found) {
            ...
            $heading = highlight($query, $page->visiblename, false, '', '');
            $headingurl = null;
            ...
            if (!empty($settings)) {
                foreach ($settings as $setting) {
                    ...
                    $newsetting = [
                        ...
                        'settingvisiblename' => empty($settingvisiblename) ? $heading : $settingvisiblename,
