...
$string['autocompletemodal'] = 'Show autocomplete in modal';
$string['autocompletemodal_desc'] = 'If enabled, autocomplete search results will be shown in a modal window.';
...
$string['autocompletesearchresult'] = 'See all search results';
$string['back'] = 'Back';
...
$string['noresultsfound'] = 'No results found for';
